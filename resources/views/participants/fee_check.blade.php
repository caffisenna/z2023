            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ url('/images/logo-sp.png') }}" class="user-image img-circle elevation-2"
                            alt="User Image">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-header bg-primary">
                            <img src="{{ url('/images/logo-sp.png') }}" class="img-circle elevation-2"
                                alt="User Image">
                            <p>
                                {{ Auth::user()->name }}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class='btn-group'>
                                                    ...
                                                    @if (empty($participant->fee_checked_at))
                                                        <a href="{{ url('/admin/fee_check/?uuid=') }}{{ $participant->uuid }}"
                                                            class="uk-button uk-button-default"
                                                            onclick="return confirm('{{ $participant->name }}様の入金チェックをします。よろしいですか？')">
                                                            <span uk-icon="check"></span></a>
                                                    @else
                                                        {{ $participant->fee_checked_at->format('Y-m-d') }}
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
